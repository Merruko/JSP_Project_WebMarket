			...
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-group row">
						<label class="col-sm-2">商品コード</label>
						<div class="col-sm-3">
							<input type="text" id="productId" name="productId" class="form-control" value='<%=rs.getString("p_id")%>' style="color:gery" readonly>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<label class="col-sm-2">在庫量</label>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="radio" name="condition" value="New "> 新品
							<input type="radio" name="condition" value="Old"> 中古
							<input type="radio" name="condition" value="Refurbished"> リファービッシュ
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2">イメージ</label>
						<div class="col-sm-5">
